...
<div class="wrapper" id="page-wrapper">
	...
	<div class="<?php echo esc_attr( $container ); ?>" id="content" tabindex="-1">
		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12 facetwp-template no-gutters">
				<?php
						...
						echo '
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 float-left ">
									<div class="col-md-12 listing white-block clearfix">
										<div class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 float-left" style="padding:0px;">
									   		<a href="' . esc_url( get_author_posts_url( $user->ID ) ) . '"><div class="card-img-top">'. get_avatar( $user->user_email , '200') .'</div></a>
										</div>

  										<div class="col-xl-9 col-lg-9 col-md-8 col-sm-8 col-8 card-body float-left">
