...
class WPUF_Email_Templates {
    ...
    public function add_settings_fields( $settings_fields ) {
        ...
        $settings_fields['wpuf_mails'][] = array(
            ...
            'desc'    => __( 'The background color for WooCommerce email templates.', 'wpuf' ),
            'default' => '#ffffff',
            'type'    => 'color',
            'class'   => 'email-setting-option',
        );
        ...
        $settings_fields['wpuf_mails'][] = array(
            ...
            'default' => "Hello! <br><br>You asked us to reset your password for your account. <br><br>To reset your password, visit the following address: <br><a href='{password_reset_link}'>Click Here</a> <br><br>Thanks!",
            'type'    => 'wysiwyg',
            'class'   => 'reset-email-setting-option',
        );
        ...
        $settings_fields['wpuf_mails'][] = array(
            ...
            'label'   => __( '<span class="dashicons dashicons-email-alt"></span> Confirmation Email', 'wpuf-pro' ),
            'type'    => 'html',
        ...
        $settings_fields['wpuf_mails'][] = array(
            ...
            'label'   => __( 'Confirmation mail subject', 'wpuf-pro' ),
        ...
        $settings_fields['wpuf_mails'][] = array(
            ...
            'label'   => __( 'Confirmation mail body', 'wpuf-pro' ),
            ...
            'default' => "Congrats! You are Successfully registered to {blogname} <br><br>To activate your account, please click the link below <br>{activation_link} <br><br>Thanks!",
            'type'    => 'wysiwyg',
            'class'   => 'confirmation-email-setting-option'
        );
