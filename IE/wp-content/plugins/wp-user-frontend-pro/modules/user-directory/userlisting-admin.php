...
class WPUF_Userlisting_Admin {
        ...
        <li>
            <div class="wpuf-legend">
                ...
                <div class="wpuf-actions">
                    <a href="#" class="wpuf-remove"><?php _e( 'Remove', '' ); ?></a>
                    <a href="#" class="wpuf-toggle"><?php _e( 'Toggle', '' ); ?></a>
                </div>
            </div>
    ...
    function print_section( $key, $val ) {
        ...
        ?>
        <div class="wpuf-form-rows">
            <label><?php _e( 'Label', 'userlisting' ); ?></label>
    ...
    function print_file( $key, $val) {
        ...
        $meta_key = isset( $val['meta_key'] ) ? esc_attr( $val['meta_key'] ) : '';
        $label = isset( $val['label'] ) ? esc_attr( $val['label'] ) : '';
        ?>
        <div class="wpuf-form-rows">
            <label><?php _e( 'Label', 'wpuf-pro' ); ?></label>
        ...
        <div class="wpuf-form-rows">
            ...
            <div class="wpuf-form-sub-fields">
                ...
                <select name="wpuf_pf_field[meta][<?php echo $key; ?>]">
                    <option value="">- select -</option>
                    <optgroup label="<?php _e( 'Profile Fields', 'wpuf-pro' ); ?>">
                        <?php $this->default_meta_dropdown( $key, $val ); ?>
                    </optgroup>
                    <optgroup label="<?php _e( 'Meta Keys', 'wpuf-pro' ); ?>">
                        <?php $this->custom_meta_key( $key, $val ); ?>
                    </optgroup>
                </select>
            </div>
        </div>
    ...
    function print_comment( $key, $val ) {
        ...
        <div class="wpuf-form-rows">
            <label><?php _e( 'Post type Comment', 'userlisting' ); ?></label>
        ...
        <div class="wpuf-form-rows">
            <label><?php _e( 'Comment count', 'userlisting' ); ?></label>
    ...
    function form_builder() {
        ...
        ?>
        <h2><?php _e( 'WP User Frontend Pro: User Listing', 'wpuf-userlisting' ); ?></h2>

        <ul class="wpuf-menu-field">
            <li class="header"><?php _e( 'Click to Add Items', 'wpuf-userlisting' ); ?></li>
        ...
        <div class="wpuf-form">
            <form method="post" action="">
                ...
                <input type="submit" name="wpuf_save_button" value="Save Changes" class="button button-primary">
            </form>
        </div>
        ...
        <script type="text/template" id="wpuf-userlistion-postype">
            ...
            <?php $this->li_wrap_open( array('label' => 'Post Listing') ); ?>
        ...
        <script type="text/template" id="wpuf-userlistion-section">
            ...
            <?php $this->li_wrap_open( array('label' => 'Section') ); ?>
        ...
        <script type="text/template" id="wpuf-userlisting-meta">
            ...
            <?php $this->li_wrap_open( array('label' => 'Meta Key') ); ?>
