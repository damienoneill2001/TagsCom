...
<div class="col-sm-12 col-md-12 col-lg-8">
		...
		<div class="row">
    	    <div class="col-lg-9 col-md-9 col-sm-12">
    	        ...
    	        <div class="images-list">
    	             ...
    	             <?php 
    	             if( !empty( $first_image_others ) ){
    	                    echo  ( function_exists('slb_activate') ) ? slb_activate( $first_image_others)  : $first_image_others;
    	             } 
    	             ?>
    	        </div>
    	    </div>
	...
	<footer class="entry-footer white-block">
		...
		<?php //understrap_entry_footer(); 
			include $_SERVER['DOCUMENT_ROOT'].'/wp-content/themes/adoptAPetChild/inc/pet-details/other-details.php';
		?>
        </div>
	</footer><!-- .entry-footer -->
</div>
