...
class WPUF_Mailchimp {
    ...
    public function add_mailchimp_menu() {
        add_submenu_page( 'wp-user-frontend', __( 'Mailchimp', 'wpuf' ), __( 'Mailchimp', 'wpuf' ), 'manage_options', 'wpuf_mailchimp', array($this, 'mailchimp_page') );
    }
    ...
    public function add_tab_profile_form() {
        ?>
        <a href="#wpuf-metabox-mailchimp" class="nav-tab" id="wpuf_mailchimp-tab"><?php _e( 'Mailchimp', 'wpuf' ); ?></a>
        <?php
    }
