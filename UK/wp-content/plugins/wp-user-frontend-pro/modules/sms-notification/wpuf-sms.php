...
class WPUF_Admin_sms {
	...
	function wpuf_sms_settings_fields( $settings_fields ) {
		...
		$settings_fields['wpuf_sms'] = apply_filters( 'wpuf_sms_field', array(
	            ...
	            array(
	                ...
	                'label' => __( 'Clickatell name', 'wpuf' ),
	                'desc' => __( 'Clickatell name', 'wpuf' ),
	                'type' => 'text',
	            ),

	            array(
	                'name' => 'clickatell_password',
	                'label' => __( 'Clickatell Password', 'wpuf' ),
	                'desc' => __( 'Clickatell Password', 'wpuf' ),
	                'type' => 'text',
	            ),

	            array(
	                'name' => 'clickatell_api',
	                'label' => __( 'Clickatell api', 'wpuf' ),
	                'desc' => __( 'Clickatell api', 'wpuf' ),
	                'type' => 'text',
	            ),
	            array(
	                'name' => 'smsglobal_name',
	                'label' => __( 'SMSGlobal Name', 'wpuf' ),
	                'desc' => __( 'SMSGlobal Name', 'wpuf' ),
	                'type' => 'text',
	            ),
	            array(
	                'name' => 'smsglobal_password',
	                'label' => __( 'SMSGlobal Passord', 'wpuf' ),
	                'desc' => __( 'SMSGlobal Passord', 'wpuf' ),
	                'type' => 'text',
	            ),
	            array(
	                'name' => 'nexmo_api',
	                'label' => __( 'Nexmo API', 'wpuf' ),
	                'desc' => __( 'Nexmo API', 'wpuf' ),
	                'type' => 'text',
	            ),
	            array(
	                'name' => 'nexmo_api_Secret',
	                'label' => __( 'Nexmo API Secret', 'wpuf' ),
	                'desc' => __( 'Nexmo API Secret', 'wpuf' ),
	                'type' => 'text',
	            ),

	            array(
	                'name' => 'twillo_number',
	                'label' => __( 'Twillo From Number', 'wpuf' ),
	                'desc' => __( 'Twillo From Number', 'wpuf' ),
	                'type' => 'text',
	            ),
	            array(
	                'name' => 'twillo_sid',
	                'label' => __( 'Twillo Account SID', 'wpuf' ),
	                'desc' => __( 'Twillo Account SID', 'wpuf' ),
	                'type' => 'text',
	            ),
	            array(
	                'name' => 'twillo_token',
	                'label' => __( 'Twillo Authro Token', 'wpuf' ),
	                'desc' => __( 'Twillo Authro Token', 'wpuf' ),
	                'type' => 'text',
	            )
	...
	function sms_form_generator( $form_settings, $post ) {
		...
		?>
		 <tr>
            <th><?php _e( 'Mobile Message', 'wpuf' ); ?></th>
                <td class="wpuf-mobile-message">
                    <label>
                        ...
                        <?php _e( 'Enable SMS', 'wpuf' ) ?>
                    </label>
                    <div class="description"><?php _e( 'Send sms for per post', 'wpuf' ); ?></div>
                </td>
            </tr>
            <tr class="wpuf-sms-wrap" style="display: <?php echo $getway_style; ?>;">
                <th><?php _e( 'Mobile Number', 'wpuf' ); ?></th>
                <td>
                    <label>
                        <input type="text" name="wpuf_settings[mob_number]" placeholder="<?php _e( 'mobile number', 'wpuf' ); ?>" value="<?php echo esc_attr( $mob_number ); ?>" />
                    </label>
                    <div class="description"><?php _e( 'SMS will send from this number', 'wpuf' ); ?></div>
                </td>
            </tr>

            <tr class="wpuf-sms-wrap" style="display: <?php echo $getway_style; ?>;">
                <th><?php _e( 'Sender Name', 'wpuf' ); ?></th>
                <td>
                    <label>
                        <input type="text" name="wpuf_settings[sms_sender_name]" placeholder="<?php _e( 'SMS sender name', 'wpuf' ); ?>" value="<?php echo esc_attr( $sender_name ); ?>" />
                    </label>
                    <div class="description"><?php _e( 'SMS sender name', 'wpuf' ); ?></div>
                </td>
            </tr>

            <tr class="wpuf-sms-wrap" style="display: <?php echo $getway_style; ?>;">
                <th><?php _e( 'SMS body', 'wpuf' ); ?></th>
                <td>
                    <label>
                        <input type="text" name="wpuf_settings[sms_body]" placeholder="<?php _e( 'Text message', 'wpuf' ); ?>" value="<?php echo esc_attr( $sms_body ); ?>" />
                    </label>
                    <div class="description"><?php _e( 'SMS body', 'wpuf' ); ?></div>
                </td>
            </tr>

            <tr class="wpuf-sms-wrap" style="display: <?php echo $getway_style; ?>;">
                <th><?php _e( 'Gateway', 'wpuf' ); ?></th>
                <td>
	...
	function get_sms_gateway( $gate_way = false ) {
        $sms_gate_way = array(
            'nexmo' => __( 'Nexmo', 'wpuf' ),
            'twillo' => __( 'Twilio', 'wpuf' ),
            'clickatell' => __( 'Clickatel', 'wpuf' ),
            'smsglobal' => __( 'SMS global', 'wpuf' )
        );
